...
mpicc -o out  MAIN.o MainInit.o MainDivision.o MainGeteig.o DVGetCeig.o DVGetInterval.o DVGetNeig.o DVGetTag.o DVModify.o DVEnd.o linearsystem.o mumps.o feast.o mul.o orth.o -L ~/lib/lib/ -lzmumps_parmetis -lmumps_common_parmetis  -lpord_parmetis  -lmetis -lparmetis -lscalapack -llapack -lblacs -lblacsCinit -lblacsF77init -lblas -lmkl_intel_lp64 -lmkl_intel_thread -lmkl_core  -liomp5 -limf -lsvml -lirc -lifcore -lpthread -lm
